...
<html lang="en">
    ...
    <body data-spy="scroll" data-target="#template-navbar">
        ...
        <section id="header-slider" class="owl-carousel" >
            ...
            <div class="item">
                <div class="container">
                    <div class="header-content @if($slider->title == 'BEST DRINKS') pull-right text-right @endif">
                ...
                <div class="row">
                    <div class="col-md-6 col-md-offset-3">
                        <div class="copyright text-center">
                            <p>
                                &copy; Copyright, 2019 <a href="">Mama's Kitchen</a> 
                                Developed by <a href="https://www.facebook.com/elsayed.ahmed.12177">Elsayd Ahmed</a>
